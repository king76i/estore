...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="724" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <br>		 
		 <form name="form" method="post" action="manager/addManager.action " onsubmit="return checkEmpty(form)">
		 <table width="58%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
          <tr>
            ...
            <input name="manager.name " type="text" size="35"></td>
          </tr>
          <tr>
            <td height="30"><div align="center">密&nbsp;码</div></td>
            <td bgcolor="#FFFFFF">&nbsp;
            <input name="manager.password " type="password" size="35"></td>
          </tr>
          <tr>
            <td height="30"><div align="center">姓&nbsp;名</div></td>
            <td bgcolor="#FFFFFF">&nbsp;
            <input name="manager.realName " type="text" size="35"> </td>
          </tr>
        </table>
		<br>  
