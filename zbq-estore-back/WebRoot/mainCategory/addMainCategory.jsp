  ...
  <tr>
    ...
    <td width="724" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <table width="723" height="25" border="0" cellpadding="0" cellspacing="0" background="image/bg_02.jpg">
          <tr>
            <td><div align="center"><strong>添加大类别信息</strong></div></td>
          </tr>
        </table>
        <br>		 
		 <form name="form" method="post" action="mainCategory/insertMainCategory.action " onsubmit="return checkEmpty(form)">
		 <table width="58%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
          <tr>
            ...
            <input name="category.name " type="text" size="35"></td>
          </tr>
           <!--
          <tr>
            <td height="30"><div align="center">id</div></td>
            <td bgcolor="#FFFFFF">&nbsp;
            <input name="category.id " type="text" size="35"></td>
          </tr>
          <tr>
